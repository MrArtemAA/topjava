...
<section>
    ...
    <form method="post" action="meals">
        ...
        <button type="submit"><spring:message code="meals.action.filter"/></button>
    </form>
    <hr>
    <a href="meals/create"><spring:message code="meals.action.add"/></a>
    <hr>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/${meal.id}/update"><spring:message code="meals.action.update"/></a></td>
                <td><a href="meals/${meal.id}/delete"><spring:message code="meals.action.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
