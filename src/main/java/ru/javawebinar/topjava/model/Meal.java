...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GETBETWEENDATES, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id AND m.dateTime BETWEEN :start_date AND :end_date ORDER BY m.dateTime DESC"),
})
...
public class Meal extends BaseEntity {
    ...
    public static final String GETBETWEENDATES = "Meal.getBetweenDates";
